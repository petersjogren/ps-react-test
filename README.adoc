...
Examples of using TypeScript can be found in the components BezierCurve.tsx, NodeList.tsx, InOutNode.tsx and HTMLNode.tsx. Using TypeScript interfaces or classes 
